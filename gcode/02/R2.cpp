...
#define Res 10
#define MaxTrail 1500
#define MaxParticles 150
#define MaxTargets 33
float dirLength;
float cellsColor[Res*Res];

double timeStep = 0.3;
double targetStrength = 0.1;
double gravityStrength = 0.0;
double spinStrength = 0.0;
double dragStrength = 0.1;
double collisonStrength = 0.2;
double collisonRadius = 4;
double magneticStrength = 0.1;
double chemicalStrength = 0;
double chemicalRadius = 5;
...
void setup()
{
	...
	{
		vel[i] = vec(0, 0, 0);
		pos[i] = vec(ofRandom(-15, 15), ofRandom(-15, 15), 0);
	}

	for (int i = 0; i < MaxTargets; i++)
	{
		target[0] = vec(-75, 0, 0);
		target[1] = vec(-75, -37.5, 0);
		target[2] = vec(-75, -75, 0);
		target[3] = vec(-37.5, -75, 0);
		target[4] = vec(0, -75, 0);
		target[5] = vec(+37.5, -75, 0);
		target[6] = vec(+75, -75, 0);
		target[7] = vec(+75, -37.5, 0);
		target[8] = vec(+75, 0, 0);
		target[9] = vec(+75, +37.5, 0);
		target[10] = vec(+75, +75, 0);
		target[11] = vec(+37.5, +75, 0);
		target[12] = vec(0, +75, 0);
		target[13] = vec(-37.5, 75, 0);
		target[14] = vec(-75, 75, 0);
		target[15] = vec(-75, +37.5, 0);
		target[16] = vec(-50, +12.5, 0);
		target[17] = vec(-50, -25, 0);
		target[18] = vec(-60, -60, 0);
		target[19] = vec(-25, -50, 0);
		target[20] = vec(+12.5, -50, 0);
		target[21] = vec(+50, -50, 0);
		target[22] = vec(+37.5, -12.5, 0);
		target[23] = vec(+50, +12.5, 0);
		target[24] = vec(+50, +50, 0);
		target[25] = vec(+12.5, +50, 0);
		target[26] = vec(-12.5, +37.5, 0);
		target[27] = vec(-50, +50, 0);
		target[28] = vec(-25, 0, 0);
		target[29] = vec(0, -25, 0);
		target[30] = vec(+12.5, 0, 0);
		target[31] = vec(+25, +25, 0);
		target[32] = vec(0, +12.5, 0);
